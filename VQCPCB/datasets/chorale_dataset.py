...
class ChoraleBeatsDataset(Dataset):
    ...
    def _part_to_tensor(self, part, part_id, offsetStart, offsetEnd):
        """
        :param part:
        :param part_id:
        :param offsetStart:
    ...
    def _voice_range_in_subsequence(self, chorale, offsetStart, offsetEnd):
        """
    ...
    def _extract_score_tensor_with_padding(self, tensor_score, start_tick, end_tick):
        """
